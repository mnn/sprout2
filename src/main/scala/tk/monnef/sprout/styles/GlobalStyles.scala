...
import tk.monnef.sprout.styles.fonts.{FontStyle, FontWeight, UdashFonts}
import tk.monnef.sprout.styles.utils.{MediaQueries, StyleUtils}
...
object GlobalStyles extends StyleSheet.Inline {
  ...
  val global = style(
    ...
    unsafeRoot("h1")(
      position.relative,
      UdashFonts.rubik(FontWeight.SemiBold),
      //      paddingTop(7 rem),
    ...
    unsafeRoot("h2")(
      UdashFonts.rubik(FontWeight.Regular),
      marginBottom(2 rem),
      lineHeight(1.2),
      fontSize(2.5 rem),
      wordWrap.breakWord,
    ...
    unsafeRoot("h3")(
      UdashFonts.rubik(FontWeight.ExtraLight),
      marginTop(4.5 rem),
